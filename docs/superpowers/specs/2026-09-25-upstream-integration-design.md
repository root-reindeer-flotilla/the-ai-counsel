...
- **Stage 3 input:** the chairman must see each evaluator's ranking text in one label space. Any evaluator text passed to Stage 3 is converted from local labels to global labels first.
